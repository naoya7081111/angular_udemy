...
export class MemberService {
  ...
  updateMember(member: Member): Observable<any> {
    return this.http.put(this.membersUrl, member, this.httpOption).pipe(
      tap((_) => this.log(`社員データ(id=${member.id})を取得しました。`)),
  ...
  addMember(member: Member): Observable<Member> {
    return this.http
      .post<Member>(this.membersUrl, member, this.httpOption)
      .pipe(
